...
╭───────────────────────────────────────────╮
│                                           │
│   Meal Analysis Eval — Composite Scorer   │
│                                           │
╰───────────────────────────────────────────╯

╔ 3.1 Recommended Architecture ══════════════════════════════════════════════════════════════════════╗
║                                                                                                    ║
║   Recommended models (best per agent)                                                              ║
║                                                                                                    ║
...
║   P50 end-to-end: 6787 ms                                                                          ║
║   P75 end-to-end: 8209 ms                                                                          ║
║   P95 end-to-end: 12093 ms                                                                         ║
║   P99 end-to-end: 19510 ms                                                                         ║
║                                                                                                    ║
║   Alternative (balanced): gpt-5.4 + gpt-4.1 + gpt-4o → 87.8/100 composite, ~6321 ms P50 (≈7%       ║
║   faster)                                                                                          ║
║                                                                                                    ║
╚════════════════════════════════════════════════════════════════════════════════════════════════════╝
