...
| Agent | Models | Score |
| --- | --- | --- |
| guardrailCheck | gpt-5.4, o4-mini | 98.6/100 |
| mealAnalysis | gpt-4.1 | 83.7/100 |
| safetyChecks | gpt-4.1, gpt-4o, gpt-5 | 87.5/100 |

**Composite eval score:** 87.8/100

**P50 end-to-end:** 6787 ms | **P75:** 8209 ms | **P95:** 12093 ms | **P99:** 19510 ms

**Alternative (balanced):** gpt-5.4 + gpt-4.1 + gpt-4o → 87.8/100 composite, ~6321 ms P50 (≈7% faster)
